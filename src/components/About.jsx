...
const About =() => {
  ...
  return (
    <div
      id="about"
      className="mt-26 max-w-screen mx-auto px-4 md:px-18 flex flex-col items-center justify-center overflow-hidden"
    >
          ...
          <Accordion type="single" collapsible className="flex flex-col gap-4">
            {cards.map((card, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="bg-white/70 rounded-xl overflow-hidden"
              >
